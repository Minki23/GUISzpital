...
public class PanelLogowanieLekarz extends PanelOgolny {
    private static final PanelLogowanieLekarz LogowanieLekarz;

    public static PanelLogowanieLekarz getLogowanieLekarz() {
        return LogowanieLekarz;
    }

    private boolean PoprawneHaslo = false;
    static {
        try {
            LogowanieLekarz = new PanelLogowanieLekarz();
        } catch (IOException e) {
