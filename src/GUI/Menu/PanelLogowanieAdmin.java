...
public class PanelLogowanieAdmin extends PanelOgolny {
        private static final PanelLogowanieAdmin LogowanieAdmin;

    public static PanelLogowanieAdmin getLogowanieAdmin() {
        return LogowanieAdmin;
    }

    private boolean PoprawneHaslo = false;
        static {
            try {
                LogowanieAdmin = new PanelLogowanieAdmin();
            } catch (IOException e) {
